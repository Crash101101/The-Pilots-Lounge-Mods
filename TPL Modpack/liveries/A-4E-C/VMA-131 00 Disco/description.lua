...
livery =
{
    {"Bottom", 0, "vma131_diamondbacks_bottom", false};
    {"Top", 0, "vma131_diamondbacks_top", false};
    {"Top", ROUGHNESS_METALLIC, "vma131_diamondbacks_RoughMet", false};
    ...
    {"nose_001", 0, "a4e_bort_white", false};
    {"nose_010", 0, "a4e_bort_white", false};
